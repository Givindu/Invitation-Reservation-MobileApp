...
public class ShoppingCart extends AppCompatActivity {
    ...
    TextView txtret1,txtret2,txtret3,txtret4,txtret5,pck;
            ...
            readRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    if (dataSnapshot.hasChild(s1)) {
                        ...
                        txtret2.setText(p.getPrice().toString());
...
*/
       ...
       public void onBackPressed(){
        ...
        builder.setTitle("Do you want to leave order?").setMessage("Are you sure?").setPositiveButton("OK", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                delete();
